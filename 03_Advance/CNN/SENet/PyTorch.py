...
seresnet = build_seresnet(input_channel=imgs_tr.shape[-1], num_classes=5).to(device)
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(seresnet.parameters(), lr=0.001)
