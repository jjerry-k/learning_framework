...
def inception_module(x, filters_b1, filters_b2_1, filters_b2_2, filters_b3_1, filters_b3_2, filters_b4, name="Inception"):
    ...
    branch2 = layers.Conv2D(filters_b2_2, 1, activation="relu", name=name+"_branch_2_3x3")(branch2)
    
    branch3 = layers.Conv2D(filters_b3_1, 1, activation="relu", name=name+"_branch_3_1x1")(x)
    branch3 = layers.Conv2D(filters_b3_2, 1, activation="relu", name=name+"_branch_3_5x5")(branch3)
    
    branch4 = layers.MaxPool2D(pool_size=3, strides=2, padding="same", name=name+"_branch_4_pool")(x)
    branch4 = layers.Conv2D(filters_b4, 1, activation="relu", name=name+"_branch_4_1x1")(x)
